...
class SQLConnectionTest {
  ...
  @Test
  void disconnect_null() throws Exception {
    SQLConnection sqlConnection = new SQLConnection(server, port, databaseName, properties, "jdbc:sqlserver://[server]:[port];[databaseName]", "login", "password");
    sqlConnection.disconnect(null);
  }
  @Test
  void disconnect() throws Exception {
    SQLConnection sqlConnection = new SQLConnection(server, port, databaseName, properties, "jdbc:sqlserver://[server]:[port];[databaseName]", "login", "password");
    try {
      sqlConnection.disconnect(new Connection() {
        @Override
      ...
      assertThat(e).hasMessageContaining("Could not close connection to database:");
    }
  }
